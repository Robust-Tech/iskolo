...
$start_date = array('name' => 'start_date','class' => 'form-control form-control-inline date-picker', 'value'=> $activity->start_date, 'placeholder' => 'Start Date', 'id' => 'date');
$end_date = array('name' => 'end_date','class' => 'form-control form-control-inline date-picker', 'placeholder' => 'Due Date', 'id' => 'date', 'value'=> $activity->end_date);
