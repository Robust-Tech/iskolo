...
class AppLib {
    ...
    public static $assessment_table = 'assessments';
    public static $announcements = 'announcements';
    public static $class_routine = 'class_routine ';
    public static $marks = 'marks';
    public static $assessment_type_table = 'assessment_types';
    public static $grades_table = 'grades';
    public static $library_table = 'library';
    public static $parents_table = 'parents';
    public static $students_table = 'students';
    public static $project_timer_table = 'project_timer';
    public static $subjects_table = 'subjects';
    public static $task_timer_table = 'tasks_timer';
    public static $profile_table = 'user_account';
