...
CREATE TABLE IF NOT EXISTS `user_account` (
  ...
  `mobile` varchar(32) DEFAULT NULL,
    `home_language` varchar(150) DEFAULT NULL,
  ...
  `prev_school_tel` varchar(150) DEFAULT NULL,
  `prev_school_address` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `assessment_types` (
  ...
  `description` text,
  `created_by` int(11) DEFAULT NULL,
  `created_date` timestamp DEFAULT NULL  CURRENT_TIMESTAMP,
  `modified_by` int(11) DEFAULT NULL,
  `modified_date` timestamp DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
